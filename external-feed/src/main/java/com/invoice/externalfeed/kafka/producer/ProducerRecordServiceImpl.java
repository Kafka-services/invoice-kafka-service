package com.invoice.externalfeed.kafka.producer;
...
public class ProducerRecordServiceImpl {
	...
	public void produceMessage(InvoiceModel invoiceModel) {
		Properties props = getKafkaProperties();

		Producer<String, Object> producer = new KafkaProducer<String, Object>(props);

		String topic = ApplicationConstant.TOPIC_NAME; // itinerary-Covid instruction

		String keyName = topic + "-" + invoiceModel.getDealerId();

		ProducerRecord<String, Object> record1 = new ProducerRecord(topic, 0, System.currentTimeMillis(), keyName,
				invoiceModel, new RecordHeaders().add(new RecordHeader(keyName, null)));
		try {
